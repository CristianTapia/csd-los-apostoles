...
type CampeonatosPageProps = {
  params: Promise<{
    clubSlug: string;
  }>;
};

export default async function CampeonatosPage({ params }: CampeonatosPageProps) {
  const { clubSlug } = await params;

  const result = await getPublicClubSection(clubSlug, "campeonatos");
