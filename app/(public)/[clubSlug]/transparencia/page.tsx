...
type TransparenciaPageProps = {
  params: Promise<{
    clubSlug: string;
  }>;
};

export default async function TransparenciaPage({ params }: TransparenciaPageProps) {
  const { clubSlug } = await params;

  const result = await getPublicClubSection(clubSlug, "transparencia");
