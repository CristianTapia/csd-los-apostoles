      ...
      <div className="flex-1 w-full">
        <div className="relative w-full h-[320px] md:h-[480px] lg:h-[560px] overflow-hidden rounded-xl">
          ...
          <div className="absolute inset-0 z-10 flex flex-col items-center justify-center gap-3 text-center px-4">
            <h2 className="text-4xl font-black leading-tight tracking-normal min-[480px]:text-5xl">
              Bienvenidos a Nuestro Club
            </h2>
            <p className="text-sm min-[480px]:text-base mb-4">Pasion, esfuerzo y comunidad.</p>
        ...
        <h3 className="text-font-main dark:text-white text-xl font-bold leading-tight tracking-normal px-4 pb-3 pt-5">
          Resultados Recientes
        </h3>
        <div className="px-4 pb-3">
          <div className="flex flex-col gap-4 rounded-xl bg-foreground text-font-main dark:bg-neutral-950 shadow-sm p-4">
        ...
        <div className="px-4 pb-3">
          <div className="flex flex-col gap-4 rounded-xl bg-foreground text-font-main dark:bg-neutral-950 shadow-sm p-4">
            ...
            <div className="flex flex-col text-center text-sm text-font-main dark:text-white">
              <p>
